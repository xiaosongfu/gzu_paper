...
<div class="body">
    <div>
       ...
       <!-- <td>单价</td><td>数量</td> -->
	       <tr><td>订单号</td><td>商品</td><td>总金额</td><td>支付方式</td><td>预定送水时间</td><td>订单状态</td><td>提交时间</td><td>备注</td><td>操作</td></tr>
	       <?php
	       if($orderResult != null){
            // echo "<pre>";
            // print_r($orderResult);
            ...
            // print_r($orderContainGoodsResult);
	            ...
	            for($t = 0;$t < $countT; $t++){
                   ...
                   ||
                   <a href="index.php?controller=Order&method=orderSettle&orderid='.$orderResult[$t]['id'].'" target="_blank">付款</a>
                   </td>
                   </tr>';
	            }
	       }
