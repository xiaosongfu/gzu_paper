...
<?php echo '<meta http-equiv="Refresh" content="2;URL=index.php?controller=Order&method=viewOrder&orderid='.$_POST['orderid'].'">';
?>
<title>订单评价--润达送水 润你生活</title>
...
<!-- 主体 -->
<div class="body">
<div style="font-size:22px;padding-top:20px;text-align:center;height:250px;">
<?php echo $info;?>
</div>
</div>
<!-- 主体结束 -->
